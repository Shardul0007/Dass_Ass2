"""Module defining the CardDeck class 
and the Chance and Community Chest card data 
...
class CardDeck:
    ...
    def __repr__(self):
        if not self.cards:
            ...
            next_idx = self.index % len(self.cards)
        return f"CardDeck({len(self.cards)} cards, next={next_idx})"
